        ...
        with gr.Tab("Main Infer"):
            ...
            with gr.Accordion('RVC options', open=False):
                with gr.Row(equal_height=True):
                    ...
                    with gr.Column():
                        f0_method = gr.Dropdown(['rmvpe', 'crepe', 'rmvpe+', 'fcpe', 'hybrid[rmvpe+fcpe'], value='rmvpe', label='Pitch detection algorithm', info='Best option is rmvpe (clarity in vocals), then mangio-crepe (smoother vocals)')
